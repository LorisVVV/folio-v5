...
"[project]/src/component/sections/ProjectSection/ProjectName/ProjectName.tsx [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {

const e = new Error("Could not parse module '[project]/src/component/sections/ProjectSection/ProjectName/ProjectName.tsx'\n\nJSX value should be either an expression or a quoted JSX text");
...
function ProjectSection(t0) {
    ...
    if ($[0] !== "97bfd90b7eb84d1daffeabf2ec65d83b92e3ae3b41bbe3112eeebec268d0f55b") {
        for(let $i = 0; $i < 7; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "97bfd90b7eb84d1daffeabf2ec65d83b92e3ae3b41bbe3112eeebec268d0f55b";
    }
        ...
        t1 = ({
            "ProjectSection[useGSAP()]": ()=>{
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gsap$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].timeline({
                    ...
                    opacity: "1",
                    duration: 1
                }).to("." + __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$component$2f$sections$2f$ProjectSection$2f$ProjectSection$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].circle, {
                    opacity: "1",
                    duration: 1
                }).to({}, {
                    duration: 1
...
_s(ProjectSection, "QALqhLwqSGAsObD6wwN18DfSr4g=", false, function() {
    return [
...
function AboutSection(t0) {
    ...
    if ($[0] !== "a767b656cce7e5dcf77db8ef3d631f8425865fc9a0dcebd8e215fef310544a35") {
        for(let $i = 0; $i < 6; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "a767b656cce7e5dcf77db8ef3d631f8425865fc9a0dcebd8e215fef310544a35";
    }
    const { scrollref, triggerRef } = t0;
    const sectionRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    let t1;
...
function ContactSection(t0) {
    _s();
    const $ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$compiler$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["c"])(6);
    if ($[0] !== "ff9c454c4d50b702b4066157723923d7aa48a4003a8c68877049fd460ddee16a") {
        for(let $i = 0; $i < 6; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "ff9c454c4d50b702b4066157723923d7aa48a4003a8c68877049fd460ddee16a";
    }
    const { scrollref, triggerRef } = t0;
    const sectionRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    let t1;
    if ($[1] !== scrollref.current || $[2] !== triggerRef) {
        t1 = ({
            "ContactSection[useGSAP()]": ()=>{
                ...
                }).set("." + __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$component$2f$sections$2f$ContactSection$2f$ContactSection$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].title, {
                    display: "flex"
...
function HeroSection(t0) {
    ...
    if ($[0] !== "643806ecf69af8aad58111df68e16fbf2e43c8a9484657a5bb1febdf7dccb98f") {
        for(let $i = 0; $i < 5; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "643806ecf69af8aad58111df68e16fbf2e43c8a9484657a5bb1febdf7dccb98f";
    }
    const { scrollref, triggerRef } = t0;
    const sectionRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    let t1;
        ...
        t1 = ({
            "HeroSection[useGSAP()]": ()=>{
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gsap$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].timeline({
                    ...
                    duration: 3
                }).to("." + __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$component$2f$sections$2f$HeroSection$2f$HeroSection$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].title, {
                    opacity: "0",
                    duration: 1
                }).to({}, {
                    duration: 1
                }).set("." + __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$component$2f$sections$2f$HeroSection$2f$HeroSection$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].title, {
                    display: "none"
                });
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gsap$2f$ScrollTrigger$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ScrollTrigger"].refresh();
            }
...
function Content() {
    ...
    if ($[0] !== "20a4c5cfe27e822b8bf8f5b02cd86c5c69c9a604b6210a5e2b242bd1bb357e13") {
        for(let $i = 0; $i < 3; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "20a4c5cfe27e822b8bf8f5b02cd86c5c69c9a604b6210a5e2b242bd1bb357e13";
    }
...
_s(Content, "gluFABr3YDcYsWBrcIMGyEOpJis=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$gsap$2f$react$2f$src$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useGSAP"]
    ];
});
...
function Home() {
    ...
    if ($[0] !== "c66fb418cf8077cb069df86f052b1aed29bc501afc1b4babf48a61eaa64d6aba") {
        for(let $i = 0; $i < 2; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "c66fb418cf8077cb069df86f052b1aed29bc501afc1b4babf48a61eaa64d6aba";
    }
...
//# sourceMappingURL=src_6045dea8._.js.map