...
function Link(t0) {
    ...
    if ($[0] !== "2b6e714ddfe1b96003b57f1549fdd2cac1a8891222f5f0ba22cbf74c3e5a56e8") {
        for(let $i = 0; $i < 14; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "2b6e714ddfe1b96003b57f1549fdd2cac1a8891222f5f0ba22cbf74c3e5a56e8";
    }
    const { data } = t0;
    let t1;
    if ($[1] !== data.content) {
    ...
    const copy = t1;
    const t2 = "Icon for " + data.content;
    let t3;
    if ($[3] !== data.iconLink || $[4] !== t2) {
    ...
    let t4;
    if ($[6] !== copy || $[7] !== data.content || $[8] !== data.link || $[9] !== data.type) {
        t4 = data.type == "link" ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("a", {
...
__turbopack_context__.v("/_next/static/media/linkedin.9b2b7edd.svg");}),
...
__turbopack_context__.v("/_next/static/media/github.0ba97581.svg");}),
...
__turbopack_context__.v("/_next/static/media/mail.50d3f71f.svg");}),
...
function ContactSection(t0) {
    ...
    if ($[0] !== "d4d2d5a207cb2d313d6594e5e3f7ade16e844519c4968ede0f14dac4ba6f5fa8") {
        for(let $i = 0; $i < 8; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "d4d2d5a207cb2d313d6594e5e3f7ade16e844519c4968ede0f14dac4ba6f5fa8";
    }
    const { scrollref, triggerRef } = t0;
    const sectionRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    let t1;
    if ($[1] === Symbol.for("react.memo_cache_sentinel")) {
        t1 = [
            ...
            },
            {
                content: "+3363819262",
                type: "link",
                iconLink: "@/assets/icons/phone.svg"
            }
        ];
        $[1] = t1;
    } else {
    ...
    const links = t1;
    let t2;
    if ($[2] !== scrollref.current || $[3] !== triggerRef) {
        t2 = ({
...
_c = ContactSection;
function _ContactSectionLinksMap(elt, index) {
...
//# sourceMappingURL=src_6e2ca45e._.js.map